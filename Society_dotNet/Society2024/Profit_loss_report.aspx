<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Profit_loss_report.aspx.cs" Inherits="Society.Profit_loss_report" MasterPageFile="~/Site.Master" %>
...
<asp:Content ID="content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table width="100%">
        <tr>
            <th width="100%">
                <h1 class="font-weight-bold" style="color: #012970;">Annual income and expenditure</h1>
            </th>
        </tr>
    </table>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="gv-container" GridLines="Both" CellPadding="0" CellSpacing="0">
        <Columns>
            ...
            <asp:BoundField DataField="current_year_income" HeaderText="Amount" DataFormatString="{0:N2}" />
            <asp:BoundField DataField="expense" HeaderText="Expense" />
            <asp:BoundField DataField="current_year_expense" HeaderText="Amount" DataFormatString="{0:N2}" />
        </Columns>
    </asp:GridView>
    ...
    <script type="text/javascript">
        function downloadPDF() {
            ...
            doc.text('Profit Loss Report', margin, margin);
