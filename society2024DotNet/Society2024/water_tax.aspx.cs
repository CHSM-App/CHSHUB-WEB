...
namespace Society2024
{
    public partial class Water_tax : System.Web.UI.Page
    {
        ...
        {
            //DataTable dt = bL_House.gridBindPeding(Session["village_id"].ToString(), "Grid_not_paid_W");
        ...
        private List<PaidHouseViewModel> GetPaidHouses()
        {
            ...
            {
                House_Id = 6,
                Owner_Name = "Vishal Pandey",
                House_No = "F-601",
                House_Sqft = 1800,
                Sqft_Charges = 3.2m,
                No_Of_Taps = 4,
                Tap_Charges = 60m,
                Solid_Waste_Fee = 145m
            };

            var house5 = new homeModal
            {
                House_Id = 6,
                Owner_Name = "Shweta Deshmukh",
                House_No = "F-602",
                House_Sqft = 1500,
                Sqft_Charges = 2.6m,
                No_Of_Taps = 3,
