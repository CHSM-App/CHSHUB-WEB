            ...
            return (
              <button
                ...
                style={{
                  ...
                  border: o.isSelected ? '1.5px solid #b91c1c' : '1px solid #e2e8f0',
              ...
              >
                ...
                <div className="mt-1.5 h-1.5 overflow-hidden rounded-full" style={{ background: '#eef2f9' }}>
                  <div
                    ...
                    style={{
                      width: `${pct}%`,
                      background: 'linear-gradient(90deg, #b91c1c, #e56b6b)',
                    }}
                  />
                </div>
              </button>
                ...
                return (
                  <li key={o.OptionId}>
                    ...
                    <div className="mt-1 h-2 rounded-full bg-slate-100">
                      <div className="h-2 rounded-full bg-[#e31b23]" style={{ width: `${pct}%` }} />
                    </div>
                  </li>
                );
              })}
