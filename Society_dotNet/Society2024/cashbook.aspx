...
<asp:Content ID="content1" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="form-group">
                    <div class="row ">
                        ...
                        <div class="col-sm-2">
                            ...
                            <asp:DropDownList Visible="false" ID="ddlTransactionType" runat="server"  >
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <asp:Button ID="btn_search" runat="server" class="download-btn"
    ...
    <script type="text/javascript">
        function downloadPDF() {
            ...
            doc.text('Financial Report', margin, margin);
            ...
            // Save the PDF
            const fileName = 'FinancialReport ' + new Date().toISOString().split('T')[0] + '.pdf';
            doc.save(fileName);
        }
    </script>
